...
public class Pager {
	...
	public static String makePage( int pagesize, int totalCnt, int curPage) {
		...
		*/
		...
		/*다음페이지 그룹당이동
		if(pageGroupStart+pageGroupSize<pageTotal){
			int temp = pageGroupEnd;
			tag=tag+"<li class=\"page-item\"><a class=\"page-link\" href=\"#\" onclick=\"goPage('"+temp+"')\">&gt;</a></li>";
		}else {
			tag=tag+"<li class=\"page-item\"><a class=\"page-link\" href=\"#\">&gt;</a></li>";
		}*/
	    ...
	    <li class="page-item"><a class="page-link" href="#">&gt;</a></li>
	    <li class="page-item"><a class="page-link" href="#" onclick="goPage('0')">1</a></li>
	    <li class="page-item"><a class="page-link" href="#" onclick="goPage('1')">2</a></li>
